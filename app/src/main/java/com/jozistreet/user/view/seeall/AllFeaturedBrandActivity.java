...
import com.jozistreet.user.view_model.seeall.AllFeaturedBrandViewModel;
...
public class AllFeaturedBrandActivity extends BaseActivity {
    private AllFeaturedBrandViewModel mViewModel;
    private AllFeaturedBrandActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AllFeaturedBrandViewModel.class);
    ...
    private void initView() {
        initParam();
        txtTitle.setText(getString(R.string.txt_featured_brand));
        nestedScrollView.setNestedScrollingEnabled(false);
        setRecycler();
        mViewModel.setIsDeliver(isDeliver);
        try {
            String local_data = DatabaseQueryClass.getInstance().getData(G.getUserID(), "AllFeaturedBrand", "");
