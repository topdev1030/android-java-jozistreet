...
import com.jozistreet.user.view_model.seeall.AllAdViewModel;
...
public class AllAdvertiseActivity extends BaseActivity {
    private AllAdViewModel mViewModel;
    private AllAdvertiseActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AllAdViewModel.class);
    ...
    private void initView() {
        initParam();
        txtTitle.setText(getString(R.string.txt_advertise));
        nestedScrollView.setNestedScrollingEnabled(false);
        setRecycler();
        mViewModel.setIsDeliver(isDeliver);
        try {
            String local_data = DatabaseQueryClass.getInstance().getData(G.getUserID(), "AllAd", "");
