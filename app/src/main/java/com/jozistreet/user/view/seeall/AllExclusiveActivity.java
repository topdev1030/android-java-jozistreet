...
import com.jozistreet.user.adapter.AllExDealAdapter;
...
import com.jozistreet.user.view_model.seeall.AllExclusiveViewModel;
...
public class AllExclusiveActivity extends BaseActivity {
    private AllExclusiveViewModel mViewModel;
    private AllExclusiveActivity activity;
    ...
    private AllExDealAdapter recyclerAdapter;
    ArrayList<PromotionModel> dealList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AllExclusiveViewModel.class);
    ...
    private void initView() {
        ...
        try {
            String local_data = DatabaseQueryClass.getInstance().getData(G.getUserID(), "AllExclusiveDeal", "");
    ...
    private void setRecycler() {
        recyclerAdapter = new AllExDealAdapter(activity, dealList, new AllExDealAdapter.AllExDealAdapterRecyclerListener() {
            @Override
