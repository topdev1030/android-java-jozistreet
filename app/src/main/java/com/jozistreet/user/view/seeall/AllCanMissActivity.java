...
public class AllCanMissActivity extends BaseActivity {
    private AllCanMissViewModel mViewModel;
    private AllCanMissActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AllCanMissViewModel.class);
    ...
    private void initView() {
        ...
        try {
            String local_data = DatabaseQueryClass.getInstance().getData(G.getUserID(), "AllCanMiss", "");
