...
public class FriendStoreFragment extends BaseFragment {
    ...
    public FriendStoreFragment() {
    }

    public static FriendStoreFragment newInstance() {
        FriendStoreFragment fragment = new FriendStoreFragment();
