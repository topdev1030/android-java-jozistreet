package com.jozistreet.user.widget.iOSDialog;
...
public class iOSDialog {
    ...
    private void initViews() {
        ...
        title_lbl.setTextSize(15);
        title_lbl.setTypeface(title_lbl.getTypeface(), Typeface.BOLD);
        subtitle_lbl.setTextSize(13);
        subtitle_lbl.setTextColor(ContextCompat.getColor(dialog.getContext(), R.color.md_grey_600));
