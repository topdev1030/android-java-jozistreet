...
public class AllDealViewModel extends ViewModel {
    ...
    public void loadLocalData() {
        try {
            String data = DatabaseQueryClass.getInstance().getData(G.getUserID(), "DealSpecial", "");
    ...
    public void loadData() {
        NewsFeedApi.getAllDealSpecial(offset.getValue(), 20, isDeliver.getValue());
    }
