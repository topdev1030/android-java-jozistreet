...
public class AllFeaturedBrandViewModel extends ViewModel {
    ...
    public AllFeaturedBrandViewModel(){
    ...
    public void loadLocalData() {
        try {
            String data = DatabaseQueryClass.getInstance().getData(G.getUserID(), "AllFeaturedBrand", "");
    ...
    public void loadData() {
        NewsFeedApi.getAllFeaturedBrand(offset.getValue(), 20, isDeliver.getValue());
    }
